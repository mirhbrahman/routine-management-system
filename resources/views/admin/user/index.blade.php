                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="badge badge-warning">Deactive</span> @endif @if ($user->isAdmin())

                            <span class="badge badge-info">Admin</span> @else

                            <span class="badge badge-dark">Reguler</span> @endif
